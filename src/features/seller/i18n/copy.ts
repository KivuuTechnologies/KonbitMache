...
export const sellerCopy: Record<Locale, SellerCopy> = {
  ht: {
    ...
    moderation: { badge: 'Retire pa moderasyon', reasonLabel: 'Rezon:', dateLabel: 'Dat:', note: 'Korije erè a epi repibliye l kòrèkteman', deleteButton: 'Efase pwodui a', deleteConfirm: 'Èske ou sèten ou vle efase pwodui sa a?', deleted: 'Pwodui efase' },
    status: { active: 'Aktif', paused: 'Kanpe', sold_out: 'Epuize' },
  ...
  fr: {
    ...
    sellerTypes: { farmer: 'Agriculteur' },
    ...
    profile: { title: 'Mon profil', subtitle: 'Gérez vos informations publiques', personal: 'Informations personnelles', business: 'Informations de l\'exploitation', contact: 'Contact', fullName: 'Nom complet', sellerType: 'Type de vendeur', businessName: 'Nom de l\'exploitation', businessNamePlaceholder: 'Ex. : Ferme Pierre', department: 'Département', comuna: 'Commune', phone: 'Téléphone', whatsapp: 'WhatsApp', frequency: 'Fréquence de vente', memberSince: 'Membre depuis', save: 'Enregistrer les modifications', saving: 'Enregistrement...', savedToast: 'Profil mis à jour (démo)', statusLabel: 'Statut du profil' },
